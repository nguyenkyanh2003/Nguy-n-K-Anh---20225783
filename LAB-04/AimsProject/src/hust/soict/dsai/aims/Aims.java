  ...
  public static void seeMediaDetails(Scanner aims) {
	...
	public static ArrayList<Media> sortMediaCart(Scanner aims) {
	    ...
	    while (true) {
	        ...
	        switch (option) {
	            case 1:
	                Collections.sort(cart.getItemsInCart(), Media.compareByTitleCost);
	                return cart.getItemsInCart();
	            case 2:
	                Collections.sort(cart.getItemsInCart(), Media.compareByCostTitle);
	                return cart.getItemsInCart();
	            default:
	                System.out.println("Invalid option. Please try again.");
	                break;
...
public static void main(String[] args) {
	CompactDisc test = new CompactDisc(1,"abc","def",1f);
	CompactDisc cd = new CompactDisc(1,"Abbey Road","Music",15.99f);
	 DigitalVideoDisc dvd = new DigitalVideoDisc(2,"The Lord of the Rings","Fantasy",19.99f);
	 Book book = new Book(3,"To Kill a Mockingbird","Ficition",10.99f);
	 store.addMedia(cd);
	 store.addMedia(dvd);
	 store.addMedia(book);
	 store.addMedia(test);
